        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-bakery-cream transition-colors">
          ...
          <div>
            ...
            <p className="text-white/80 mb-4">
              Subscribe to receive updates on new products, special offers, and events.
            </p>
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                type="email"
                placeholder="Your email address"
                className="px-4 py-2 rounded-md text-bakery-chocolate focus:outline-none"
              />
              <button
                type="submit"
                className="bg-bakery-gold text-bakery-chocolate px-4 py-2 rounded-md font-medium hover:bg-bakery-cream transition-colors"
              >
                Subscribe
              </button>
            </form>
