      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-bakery-brown">123 Main Street, Bakeryville, CA 90210</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-bakery-brown">(555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-bakery-brown">hello@nageshsbakery.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-bakery-brown">Monday - Friday: 7AM - 7PM</p>
                    <p className="text-bakery-brown">Saturday: 8AM - 8PM</p>
                    <p className="text-bakery-brown">Sunday: 8AM - 4PM</p>
                  </div>
                </div>
              </div>
          ...
          <div className="h-96 rounded-lg overflow-hidden shadow-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.7369209641227!2d-122.41941492393517!3d37.774929213553634!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858085d13aa0e9%3A0x927a8ebbe323c246!2sFerry%20Building%2C%20San%20Francisco%2C%20CA%2094111!5e0!3m2!1sen!2sus!4v1712943835458!5m2!1sen!2sus" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
